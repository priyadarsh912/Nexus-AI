...
const emergencyContacts = [
  { name: "Campus Medical Center", number: "1800-XXX-XXXX", type: "medical", icon: Stethoscope, available: "24/7" },
  { name: "Campus Security", number: "1800-XXX-YYYY", type: "security", icon: Shield, available: "24/7" },
